    ...
    <>
      ...
      <aside className={`drawer ${drawerOpen ? 'open' : ''}`} aria-hidden={!drawerOpen}>
        <div className="drawer-h">
          <Logo compact />
          <button className="bdj-icon-btn" aria-label="Close" onClick={() => setDrawerOpen(false)}>
        ...
        <nav className="drawer-nav">
          ...
          {user ? (
            <>
              ...
              <Link href="/dashboard/saved"><span className="ic"><IconBookmark width={18} height={18} /></span> {t.save}</Link>
            </>
          ) : (
            <>
          ...
          {isAdmin && (
            <Link href="/admin"><span className="ic"><IconCog width={18} height={18} /></span> Admin</Link>
          )}
          {user && (
