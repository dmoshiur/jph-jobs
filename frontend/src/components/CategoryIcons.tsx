...
const IconDefault = IconBriefcase;

/**
 * Maps job-category slugs (see backend/database/seed.ts CATEGORIES, run through
 * slugify) to an icon. `default` is the fallback for unmapped categories.
 */
export const CategoryIcons = {
  'accountingfinance': IconMoney,
  'marketingsales': IconChart,
  'ittelecommunication': IconKeyboard,
  'educationtraining': IconGraduation,
  'engineering': IconCog,
  'healthcare': IconHeart,
  'productionoperation': IconBuilding,
  'hospitality': IconStore,
  'agro': IconLeaf,
  'ngodevelopment': IconUsers,
  ...
  default: IconDefault,
} satisfies Record<string, (x: SVGProps<SVGSVGElement>) => ReactElement>;
